...
const { billAmount, tipPercentage, numPeople, calculateBtn, resultsDiv, tipAmountSpan, totalBillSpan, perPersonSpan } = elements;
...
const { calculateTip, calculateTotal, calculatePerPerson } = config;
